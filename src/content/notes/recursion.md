...
- A function that calls itself until a problem is solved. The point at which the problem is solved is called **base
  case**.
...
- **Always have a well-defined base case.**
...
- Tail Call Optimization:
  - The compiler or interpreter transforms a recursive function into a loop in order to avoid getting a stack overflow.
    You'll get an infinite loop if you mess up though.
