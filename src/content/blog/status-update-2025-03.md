...
March has been a slow month. I've not been doing much.
...
I don't tinker much with my self-hosted setup. It works fine without me having to constantly monitor it. However, once a
month or so I check if there are any new applications worth deploying. This month I decided to try to add a single
...
stuff with D-Bus. Apart from that not much else. The lifting tracker app has been stale for a while. I need to get back
to it.
