...
yet. For the time being, I've been using [nvim-orgmode/orgmode](https://github.com/nvim-orgmode/orgmode) with Neovim.
...
of a system like this might be overkill. Also, I already have a bunch of [notes](/notes) written in Markdown. I don't
want to deal with migrating them to another format since I'll have to rework my publishing setup. For now, the only
thing I'm using Org Mode for is to track my workouts.

## Reading

I finished [Leviathan Wakes](https://www.goodreads.com/book/show/8855321-leviathan-wakes). I've heard amazing things
about The Expanse and this book in particular, but I didn't like it that much.
...
been already bombarded with content discussing the topic of AI and LLMs.

I wouldn't recommend it if you are already familiar with LLMs. The group of people that would benefit the most from this
...
do, but I might add support for other forms of training in the future. The main goal is to have an app that is easy to
use and that I can host myself. I'll release it with an open source license when it is ready.
